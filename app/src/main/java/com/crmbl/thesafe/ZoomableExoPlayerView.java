    ...
    public void setPlayer(Player player) {
        ...
        if (this.player != null) {
            ...
            if (oldVideoComponent != null) {
                ...
                if (surfaceView instanceof ZoomableTextureView) {
                    oldVideoComponent.clearVideoTextureView((ZoomableTextureView) surfaceView);
        ...
        if (player != null) {
            ...
            if (newVideoComponent != null) {
                if (surfaceView instanceof ZoomableTextureView) {
                    newVideoComponent.setVideoTextureView((ZoomableTextureView) surfaceView);
                } else if (surfaceView instanceof SurfaceView) {
...
//    }
     ...
     */
    private static void applyTextureViewRotation(ZoomableTextureView textureView, int textureViewRotation) {
    ...
    private final class ComponentListener extends Player.DefaultEventListener
        ...
        public void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees, float pixelWidthHeightRatio) {
            ...
            if (surfaceView instanceof ZoomableTextureView) {
                ...
                applyTextureViewRotation((ZoomableTextureView) surfaceView, textureViewRotation);
            }
        ...
        public void onLayoutChange(
                ...
                int oldRight,
                int oldBottom) {
            applyTextureViewRotation((ZoomableTextureView) view, textureViewRotation);
        }
    }
}